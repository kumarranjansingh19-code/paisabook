...
const CREDIT_PHRASES = /\b(payment (?:of [^.]{0,40}?)?(?:has been |was |is )?received|received (?:a |your )?payment|payment (?:has been |was |is )?credited|credited to your (?:card|account|a\/c)|thank you for (?:your )?payment|dividend|interest credited|refund(?:ed)? (?:of|to)|cashback (?:of|credited))\b/i;
